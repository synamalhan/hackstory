...
import introImage from "./assets/images/intro.jpg"; // Make sure this path is correct
import bayardChildren from "./assets/images/bayard_children.jpg";
import bayardMLK from "./assets/images/bayard_mlk.webp";
import washingtonBG from "./assets/images/washington_bg.jpg"; // Ensure this path is correct
const App = () => {
  return (
...
<ParallaxLayer offset={2.9} factor={1}>
  <div
    style={{
...
<ParallaxLayer offset={1.9} speed={0.2} factor={1}>
  ...
  />
        ...
        {/* Timeline Section */}
        <ParallaxLayer offset={2.4} speed={0.7} factor={2}>
          <Timeline />
        </ParallaxLayer>
